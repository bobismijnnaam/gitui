...
pub const OPEN_HELP: KeyEvent = no_mod(KeyCode::Char('?'));
pub const MOVE_LEFT: KeyEvent = no_mod(KeyCode::Char('h'));
pub const MOVE_RIGHT: KeyEvent = no_mod(KeyCode::Char('l'));
pub const HOME: KeyEvent = no_mod(KeyCode::Home);
pub const END: KeyEvent = no_mod(KeyCode::End);
pub const MOVE_UP: KeyEvent = no_mod(KeyCode::Char('k'));
pub const MOVE_DOWN: KeyEvent = no_mod(KeyCode::Char('j'));
